                    ...
                    <div className='bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 p-8 relative overflow-hidden transition-colors duration-300'>
                        ...
                        <div className='text-center mb-7'>
                            <div className='w-14 h-14 bg-brand-50 dark:bg-brand-900/20 rounded-2xl flex items-center justify-center mx-auto mb-4 transition-colors'>
                                <UserPlus className='text-brand-500 dark:text-brand-400' size={24} />
                            </div>
                            <h1 className='text-2xl font-bold text-gray-800 dark:text-white'>Create Account</h1>
                            <p className='text-gray-400 dark:text-gray-500 text-sm mt-1'>Start your journey to your dream job</p>
                        </div>
                        ...
                        <form onSubmit={submitHandler} className='space-y-4'>
                            ...
                            {/* Profile Photo */}
                            <div>
                                <label className='text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5 block'>Profile Photo <span className='text-gray-400 dark:text-gray-500 font-normal'>(optional)</span></label>
                                <div className='relative'>
                                    <input
                                        type="file"
                                        accept="image/*"
                                        onChange={changeFileHandler}
                                        className='w-full text-sm file:mr-4 file:py-2.5 file:px-5 file:rounded-xl file:border-0 file:text-sm file:font-medium file:bg-brand-50 dark:file:bg-brand-900/40 file:text-brand-500 dark:file:text-brand-400 hover:file:bg-brand-100 dark:hover:file:bg-brand-900/60 border border-gray-200 dark:border-gray-700 rounded-xl cursor-pointer transition-all duration-200 bg-white dark:bg-gray-900 text-gray-900 dark:text-white'
                                    />
                                </div>
                            </div>
                            ...
                            {loading ? (
                                ...
                                <button type="submit" className='btn-primary w-full bg-brand-500 text-white py-3 rounded-xl font-semibold hover:bg-brand-600 shadow-lg shadow-brand-500/30 transition-all duration-200 transform hover:-translate-y-0.5'>
                                    Create Account
                                </button>
                            )}
                        </form>
                        ...
                        <p className='text-sm text-center mt-6 text-gray-500 dark:text-gray-400'>
                            Already have an account? <Link to="/login" className='text-brand-500 dark:text-brand-400 font-semibold hover:text-brand-600 dark:hover:text-brand-300 transition-colors'>Sign In</Link>
                        </p>
                    </div>
                </div>
            </div>
