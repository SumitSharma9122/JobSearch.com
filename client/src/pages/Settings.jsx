...
const Settings = () => {
    ...
    const Toggle = ({ enabled, onToggle }) => (
        <button
            onClick={onToggle}
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${enabled ? 'bg-brand-500' : 'bg-gray-200'}`}
        >
            ...
            <div className='max-w-5xl mx-auto px-4 py-8'>
                ...
                <div className='flex flex-col md:flex-row gap-6'>
                    ...
                    <div className='w-full md:w-56 shrink-0 animate-fade-in-up'>
                        <div className='bg-white rounded-2xl border border-gray-100 shadow-sm p-2 space-y-1 sticky top-24'>
                            {tabs.map(tab => (
                                <button
                                    key={tab.id}
                    ...
                    <div className='flex-1 animate-fade-in-up stagger-2 opacity-0'>
                                    ...
                                    <div>
                                        ...
                                        <div className='relative'>
                                            ...
                                            <input
                                                ...
                                                className='w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl text-sm hover:border-gray-300'
                                            />
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div className='bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden'>
                                ...
                                <div className='p-6 space-y-5'>
                                    {['currentPassword', 'newPassword', 'confirmPassword'].map((field, i) => {
                                        ...
                                        return (
                                            <div key={field}>
                                                <label className='text-sm font-medium text-gray-700 mb-1.5 block'>{labels[i]}</label>
                                                <div className='relative'>
                                                    ...
                                                    <input
                                                        ...
                                                        className='w-full pl-10 pr-11 py-3 border border-gray-200 rounded-xl text-sm hover:border-gray-300'
                                                    />
                                    ...
                                    <div className='bg-amber-50 border border-amber-100 rounded-xl p-4'>
                                        <p className='text-sm text-amber-700'>Password must be at least 8 characters with a mix of letters, numbers, and symbols.</p>
                                    </div>
                                </div>
                            ...
                            <div className='bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden'>
                                ...
                                <div className='p-6 space-y-6'>
                                    ...
                                    <div className='flex items-center justify-between'>
                                        <div>
                                            <p className='text-sm font-medium text-gray-700'>Weekly Job Digest</p>
                        ...
                        {activeTab === 'privacy' && (
                            <div className='bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden'>
                                <div className='p-6 border-b border-gray-100'>
                                    <h2 className='text-lg font-bold text-gray-800'>Privacy & Visibility</h2>
                            ...
                            <div className='bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden'>
                                ...
                                <div className='p-6'>
                                    ...
                                    <div className='grid grid-cols-3 gap-3'>
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={`flex flex-col items-center gap-3 p-5 rounded-2xl border-2 transition-all duration-200 hover:shadow-sm ${theme === t.id ? 'border-brand-500 bg-brand-50/50' : 'border-gray-200 hover:border-gray-300'}`}
                                            >
                                                <div className={`w-14 h-10 rounded-lg ${t.preview} ${theme === t.id ? 'border-brand-300' : 'border-gray-200'}`}></div>
                                    ...
                                    <div className='mt-8 bg-blue-50 border border-blue-100 rounded-xl p-4 flex items-start gap-3'>
                                        ...
                                        <div>
                                            <p className='text-sm font-medium text-blue-700'>Language & Region</p>
                                            <p className='text-xs text-blue-500 mt-0.5'>Currently set to <strong>English (India)</strong>. Language settings will be available in a future update.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
